...
{
    public partial class fAddToCreditClass : Form
    {
        private DataTable table;
        private int[] choose = new int[2];

        public fAddToCreditClass()
        {
            InitializeComponent();
        ...
        private void btIPOK_Click(object sender, EventArgs e)
        {
            if (Check())
            {
                ...
                dgvListStudent = CreditClassDAO.Instance.AddToCreditClass(column, dgvListStudent);
